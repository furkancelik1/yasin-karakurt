...
router.get('/stats', auth_middleware_1.authenticate, checkin_controller_1.getCheckInStats);
router.get('/client/:userId/stats', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)('TRAINER', 'ADMIN'), checkin_controller_1.getClientStats);
router.get('/summary/:userId', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)('TRAINER', 'ADMIN'), checkin_controller_1.getCheckInSummary);
